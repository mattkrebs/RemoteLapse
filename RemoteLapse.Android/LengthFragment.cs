...
{
    public class LengthFragment : Fragment, View.IOnTouchListener
    {
        int sensitivity = 5;
        TextView txtSetting;
        float _lastX;
        ...
        {
            txtSetting.Text = String.Format("{0} min", LapseSettings.Instance.Lenght);
        }
        ...
        public bool OnTouch(View v, MotionEvent ev)
        {
            ...
            switch (ev.Action)
            {
                ...
                case MotionEventActions.Move:
                    ...
                    {
                        _lastY = y;
                        LapseSettings.Instance.DecreaseLenght();
                        UpdateSetting();
                    ...
                    {
                        _lastY = y;
                        LapseSettings.Instance.IncreaseLenght();
                        UpdateSetting();
